...
/*
    This class is excactly the same as ModClientEvents
 */

@Mod.EventBusSubscriber(modid = AquaticAdditions.MOD_ID, bus= Mod.EventBusSubscriber.Bus.FORGE, value = Dist.DEDICATED_SERVER)
